...
class ShoppingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping" do
    assert_difference("Shopping.count") do
      post shoppings_url, params: { shopping: { adress: @shopping.adress, cnpj: @shopping.cnpj, name: @shopping.name, phone: @shopping.phone } }
    end
  ...
  test "should update shopping" do
    patch shopping_url(@shopping), params: { shopping: { adress: @shopping.adress, cnpj: @shopping.cnpj, name: @shopping.name, phone: @shopping.phone } }
